...
train_gen = processor.get_generator('train', batch_size=BATCH_SIZE, rgb_to_id=rgb_to_id, shape=INPUT_SHAPE, classes=CLASSES)
val_gen = processor.get_generator('val', batch_size=BATCH_SIZE, rgb_to_id=rgb_to_id, shape=INPUT_SHAPE, classes=CLASSES)
test_gen = processor.get_generator('test', batch_size=BATCH_SIZE, rgb_to_id=rgb_to_id, shape=INPUT_SHAPE, classes=CLASSES)
...
with open('./results/results.txt', 'a+') as f:
    f.write(f"{num:03} {BATCH_SIZE} {NO_OF_EPOCHS} {LR} {test_res[0]}")
